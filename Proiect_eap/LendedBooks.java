...
public class LendedBooks extends Books{
    ...
    public LendedBooks(int bookId, String author, String title, String description, String issuedDate, long daysFromIssue, boolean isLended){
        super(bookId, author, title, description, isLended);
