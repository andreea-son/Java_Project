...
public class PartnerService {
    ...
    public void addNewBook() throws SectionNotFoundException, BookAlreadyAddedException{
        ...
        LibrarianService.getSections().set(sectionId - 1, new Sections(sectionId, LibrarianService.getSections().get(sectionId - 1).getSectionName(), sectionBooks.get(sectionId)));
        ...
        LibrarianService.getPartners().set(partnerId - 1, new Partners(partnerId, i, partnerName, LibrarianService.getPartners().get(partnerId - 1).getPartnerPassword(), partnerEmail, partnerBooks.get(partnerId)));
    }
